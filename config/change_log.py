...
2025-09-29
[1] Bug Fixed
    - Fixed a bug DeepSeek not working.
    - Fixed the sound system.
        If not needed, set the volume to 0 in the options.
        (Others tab -> Effect Volume)
    - Fixed a bug with the right-click function to send to AI.

[2] Enhanced
    - Added Duck duck go AI Chat!🦆
    - Added a feature to open URLs.
    - Added several tooltips.

2025-08-06
[1] Enhanced
    - Added support for Microphone.
    - Added support for Grok.
    - Added support for Dark mode.

[2] Bug Fixed
    - Fixed a bug Perplexity not working.
    - Fixed a bug Claud not working.


2025-06-22
[1] Bug fixed (Added support for latest Anki)
    - Added workaround for bug that add-on cannot be launched on latest Anki.
    - Fixed a bug that buttons do not work on the latest Anki.

2025-03-26
[1] Fixed a bug with DeepSeek not working.
